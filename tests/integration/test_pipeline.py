...
from rag_ccdep.orchestrator import fusion as fusion_mod
from rag_ccdep.orchestrator import orchestrator as orch_mod
from rag_ccdep.orchestrator.orchestrator import Orchestrator
...
def test_engine_client_headers():
    ...
    from rag_ccdep.orchestrator.registry import EngineClient
