...
from rag_ccdep.core.tables_retriever import _is_static_table
from rag_ccdep.core.timeseries_retriever import _df_is_valid_timeseries, _is_temporal_table
from rag_ccdep.core.runtime import estimate_tokens, limit_context
from rag_ccdep.engines.raptor.raptor_engine import _raptor_level
...
def test_sincronizacao_incremental_carrega_apenas_arquivo_novo(tmp_path, monkeypatch):
    import rag_ccdep.core.index_sync as sync
