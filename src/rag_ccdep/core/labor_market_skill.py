...
class LaborMarketSkill:
    ...
    def __init__(self, base_dir: str):
        # A raiz do projeto é canônica; caminhos próximos ao runtime ficam como
        # compatibilidade para instalações personalizadas.
        candidates = [
            os.path.join(project_root(), self._SKILL_REL),
