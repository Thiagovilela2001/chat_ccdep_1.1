...
from rag_ccdep.core.api_security import (
...
from rag_ccdep.core.api_models import QueryRequest, QueryResponse
from rag_ccdep.core.query_service import execute_engine_query
from rag_ccdep.core.metrics import MetricsMiddleware, render_prometheus
from .query_interpreter import interpret_query
from .startup import initialize

RAG_TYPE = "agentic"
RAG_LABEL = "Agentic RAG"
...
async def lifespan(app: FastAPI):
    ...
    base_dir = str(runtime_dir(RAG_TYPE))
...
app = FastAPI(
    title=RAG_LABEL,
    description="API do Agentic RAG para consultas sobre dados economicos de Sao Paulo.",
    version="2.0.0",
    lifespan=lifespan,
)
