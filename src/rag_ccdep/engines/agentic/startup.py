"""
Startup — inicialização do Agentic RAG.

Idêntico ao rag_principal/src/startup.py, exceto que instancia
...
from rag_ccdep.core.llm import make_llm, require_api_key
from rag_ccdep.core.logger import get_logger, setup_logging
from rag_ccdep.core.index_manifest import (
    resolve_data_dir,
    resolve_db_dir,
)
from rag_ccdep.core.index_sync import sync_standard_index
from rag_ccdep.core.indexing import load_nodes_cache
from rag_ccdep.core.text_retriever import build_hybrid_retriever, rerank_top_n, TextRetriever
from rag_ccdep.core.tables_retriever import TablesRetriever
from rag_ccdep.core.timeseries_retriever import TimeSeriesRetriever
from .agent_engine import AgenticEngine
from rag_ccdep.core.domain_skills import DomainSkillRegistry

log = get_logger(__name__)

def initialize(base_dir: str, data_dir: str | None = None) -> tuple[AgenticEngine, object]:
    """
    Inicializa o Agentic RAG e retorna (engine, interp_llm).
    ...
    data_dir : str | None
        Diretório dos documentos. Se None, resolve a base compartilhada em data/.
    """
    require_api_key()
    ...
    engine = AgenticEngine(text_ret, tables_ret, ts_ret, llm, domain_skills=domain_skills)

    log.info("Agentic RAG pronto")
