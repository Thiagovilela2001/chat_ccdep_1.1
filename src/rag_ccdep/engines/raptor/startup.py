...
from rag_ccdep.core.llm import interp_model, make_llm, require_api_key
...
from rag_ccdep.core.text_retriever import TextRetriever, build_hybrid_retriever, rerank_top_n
...
def initialize(base_dir: str, data_dir: str | None = None) -> tuple[RaptorEngine, object]:
    ...
    data_dir : str | None
        Diretório dos documentos PDF. Se None, usa a base compartilhada em data/.
    """
    require_api_key()
